<x-guest-layout>
    ...
    >
        <div>
            ...
            <p>Join top candidates hiring in Canada</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input id="headline" type="text" name="headline" :value="old('headline')" placeholder="e.g. Senior Software Architect" />
                <x-input-error :messages="$errors->get('headline')" />
            </div>

            <div>
                <x-input-label for="linkedin" :value="__('LinkedIn Profile URL')" />
                <x-text-input id="linkedin" type="url" name="linkedin" :value="old('linkedin')" placeholder="https://linkedin.com/in/username" />
