        ...
        <nav class="flex-1 px-4 py-6 space-y-8">
            @auth
                ...
                <div class="space-y-1.5">
                    <a href="{{ route('messages.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all group {{ request()->routeIs('messages.*') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <span class="bg-blue-600 text-white text-[11px] font-black px-2 py-0.5 rounded-full shadow-sm">2</span>
                    </a>
                ...
                @role('job_seeker')
                    <div class="space-y-1.5">
                        ...
                        <a href="{{ route('seeker.resume-builder') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl font-medium transition-all group {{ request()->routeIs('seeker.resume-builder') ? 'bg-blue-50 text-blue-700 dark:bg-blue-900/20 dark:text-blue-400 font-bold' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                            <svg class="w-6 h-6 opacity-75 group-hover:opacity-100 group-hover:scale-110 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                            </svg>
                            <span class="flex-1">Resume Builder</span>
                        </a>
